        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               String country_name= countrtModelList.get(position).getCountry();
                ...
                save_country_name(country_name);
                startActivity(new Intent(getApplicationContext(),Country_Details_show.class).putExtra("position",position));
...
//old https://corona.lmao.ninja/v2/countries
    ...
    public void save_country_name(String name) {
